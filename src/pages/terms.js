  ...
  <div className="terms-page">
    ...
    <div className="terms-container">
      ...
      <div className="terms-text">
        ...
        <p>BY USING THE SCANSAVER APP, YOU AGREE TO THESE TERMS (“Agreement”). If you do not agree to the terms of this Agreement, do not use the ScanSaver App. This Agreement is between Sheprd Technologies Inc. (“Licensor”) and you. You must be 18 years or older.</p>
        ...
        <p><b>5. Questions or Complaints:</b>  You may submit any questions or complaints <a key="email" href={'mailto:team@linklater.app'}>here</a>.
        </p>
      </div>
